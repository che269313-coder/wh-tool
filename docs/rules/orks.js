...
(function (root) {
  ...
  "factionRules": [
    {
      "id": "orks.army.waagh",
      "name": "WAAAGH!",
      "text": "如果你的军队阵营是兽人，则你拥有全场一次性能力：在你的指挥阶段开始时，你可以发动 WAAAGH!。直到你的下一个指挥阶段开始时，以下效果对你的军队生效：你军队中拥有此能力的单位可以在进行过加速的同一回合发动冲锋；你军队中拥有此能力的模型所装备的近战武器 S 和 A 均 +1；你军队中拥有此能力的模型获得 5+ 特殊保护。",
      "status": "部分计算支持：勾选后计入近战武器力量 +1、近战攻击次数 +1 和 5+ 无敌豁免；前进后冲锋资格保留原文显示。",
      "controls": [
        {
          "id": "enabled",
          "type": "checkbox",
          "label": "本次战斗已发动 WAAAGH!"
        }
      ],
      "effects": [
        {
  ...
  "unitRules": {
    "战斗堡垒": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6, Firing Deck 11",
          "kind": "core"
        }
      },
      {
    ...
    "兽霸头目": [
      {
        ...
        "source": {
          "englishName": "Feel No Pain 6+, Leader",
          "kind": "core"
        }
      },
      {
    ...
    "鬼祟鼠": [
      {
        ...
        "source": {
          "englishName": "Infiltrators, Leader, Lone Operative, Stealth",
          "kind": "core"
        }
      },
      {
    ...
    "脏枪混混": [
      {
        ...
        "name": "枪狂炫技",
        "text": "此单位中的每个模型每次用魔改炫枪瞄准最接近的合格目标时，至本阶段结束，该武器的攻击次数特性变为 4。",
        "status": "已结构化，当前仅供查阅",
        "source": {
          "file": "欧克兽人-网站原始数据.json",
          "record": 20,
    ...
    "碎骨者萨拉卡": [
      ...
      },
      {
        ...
        "name": "伟大之WAAAGH!的传道者",
        "text": "此单位领导一个单位时，该单位中的模型每次进行近战攻击时，命中掷骰 +1，致伤掷骰 +1，若WAAAGH!对你的军队有效，未修正命中掷骰为 5+ 视为暴击命中。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
            "type": "checkbox",
            "label": "WAAAGH!对本军队处于启动状态"
          },
          {
            "id": "forceLeader",
            "type": "checkbox",
      ...
      },
      {
        ...
        "name": "碎骨者的WAAAGH!旗帜【光环】",
        "text": "当己方 **欧克蛮人(Orks)** 单位在马卡利12\"范围内时，如果你的军队的WAAAGH!处于活跃状态，该单位中的模型配备的近战武器具有 **[致命一击]** 能力。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
    ...
    "搞哥金刚": [
      ...
      },
      {
        ...
        "name": "大脚践踏",
        "text": "此模型每次进行近战攻击时，若WAAAGH!对你的军队有效，命中掷骰+1。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
    ...
    "强巨史古革巨兽": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise 2D6, Firing Deck 20",
          "kind": "core"
        }
      },
      {
    ...
    "狩猎战车": [
      {
        ...
        "source": {
          "englishName": "Deadly Demise D6, Feel No Pain 6+, Firing Deck 11",
          "kind": "core"
        }
      },
      {
    ...
    "杀戮战车": [
      {
        ...
        "source": {
          "englishName": "Deadly Demise D6, Feel No Pain 6+",
          "kind": "core"
        }
      },
      {
    ...
    "超重装老大": [
      {
        ...
        "name": "表演时间",
        "text": "当「WAAAGH!」对你的军队活跃时，此单位中的模型具有不觉疼痛5+ 能力。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
    ...
    "毛哥金刚": [
      ...
      },
      {
        ...
        "name": "大炮轰炸",
        "text": "此模型每次进行远距攻击时，若WAAAGH!对你的军队生效，命中掷骰 +1。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
    ...
    "卡车": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D3, Firing Deck 12",
          "kind": "core"
        }
      },
      {
    ...
    "战争头目": [
      ...
      },
      {
        ...
        "name": "最大最强",
        "text": "当WAAAGH!对你的军队启动时，此模型的近战武器的攻击次数特性增加 4。",
        "status": "计算支持（满足条件时自动计入）",
        "controls": [
          {
            "id": "waaghActive",
    ...
    "超重装战争头目": [
      ...
      },
      {
        ...
        "name": "恐怖蛮力",
        "text": "当WAAAGH!对你的军队启动时，此模型的「巨大砍刀」伤害特性值为 3。",
        "status": "已结构化，当前仅供查阅",
        "source": {
          "file": "欧克兽人-网站原始数据.json",
          "record": 49,
    ...
    "瓦兹达卡·古茨梅克": [
      {
        "id": "core-bundle",
        "name": "核心技能",
        "text": "致命破灭D3，深入打击，独行特工",
        "status": "通用核心技能，规则全文见《核心规则》",
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D3, Deep Strike, Lone Operative",
          "kind": "core"
        }
      },
      {
    ...
    "巫术小子": [
      {
        ...
        "source": {
          "englishName": "Deadly Demise D3, Feel No Pain 6+, Leader",
          "kind": "core"
        }
      },
      {
    ...
    "监工祖哥高德": [
      ...
      },
      {
        ...
        "name": "特殊药剂",
        "text": "当WAAAGH!对你的军队有效时，此单位中的模型移动特性加6\"。",
        "status": "已结构化，当前仅供查阅",
        "source": {
          "file": "欧克兽人-网站原始数据.json",
          "record": 54,
    ...
    "红哥布的铁皮人": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Lone Operative, Scouts",
          "kind": "core"
        }
      },
      {
    ...
    "格洛特玛斯小子": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Lone Operative, Feel No Pain, Scouts",
          "kind": "core"
        }
      },
      {
    ...
    "技师德雷德步行机": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Walker, Deadly Demise D3",
          "kind": "core"
        }
      },
      {
    ...
    "战斗轰炸机": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Fly, Aircraft, Deadly Demise D3",
          "kind": "core"
        }
      }
    ],
    ...
    "巨虫兽": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6, Firing Deck 10",
          "kind": "core"
        }
      },
      {
    ...
    "死亡碾压战争堡垒": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6+2, Transport",
          "kind": "core"
        }
      },
      {
    ...
    "大履带车": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D3, Transport",
          "kind": "core"
        }
      },
      {
    ...
    "疯狂医师格洛斯尼克": [
      {
        ...
        "source": {
          "englishName": "Leader, Feel No Pain 5+, Leader 2",
          "kind": "core"
        }
      },
      {
    ...
    "奇诺克战斗旋翼机": [
      {
        "id": "core-bundle",
        "name": "核心技能",
        "text": "飞行，致命破灭D3，运输，深入打击",
        "status": "通用核心技能，规则全文见《核心规则》",
        "effects": [],
        "source": {
          "englishName": "Fly, Deadly Demise D3, Transport, Deep Strike",
          "kind": "core"
        }
      },
      {
    ...
    "大炮组": [
      {
        ...
        "name": "WAAAGH!",
        "text": "此单位的WAAAGH!效果由欧克兽人阵营技能统一计算。",
        "status": "已结构化，当前仅供查阅",
        "source": {
          "file": "欧克兽人-网站原始数据.json",
          "record": 80,
    ...
    "老大札格斯特拉克": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Leader, Deep Strike, Feel No Pain",
          "kind": "core"
        }
      },
      {
    ...
    "执旗强蛮人": [
      {
        ...
        "name": "瓦戈！旗帜",
        "text": "■ 此单位具有 5+ **无敌豁免(InSv)**。 ■ 当「WAAAGH!」对此单位活跃时，此单位的 **T** +1。",
        "status": "已结构化，当前仅供查阅",
        "source": {
          "file": "欧克兽人-网站原始数据.json",
          "record": 97,
  ...
  const identities = root["WarhammerOrksRuleIdentities"];
  root["WarhammerOrksRules"] = identities?.apply(catalog) || catalog;
