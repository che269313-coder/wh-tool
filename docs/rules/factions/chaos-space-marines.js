...
(function (root) {
  ...
  "unitRules": {
    "掠夺者阿巴顿": [
      ...
      {
        "id": "faction-dark-pacts",
        "name": "黑暗契约",
        "text": "若你的军队阵营为 **异端阿斯塔特(Heretic Astartes)**，每次选择具有此能力的单位射击或战斗时，它可以签订黑暗契约。若它这样做，首先必须进行领导力测试，然后再解决该黑暗契约的任何效果；若测试失败，该单位受到 D3 点死亡伤害。然后，为该单位的武器选择以下其中一项能力，直到该阶段结束为止获得：\n\n■ **[致命一击]**\n■ **[连击 1]**\n\n异端阿斯塔特的亵渎冠军以狂热的虔诚恳求混沌诸神，承诺献上最邪恶的祭品以换取其力量。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "混沌摩托骑兵": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 任意数量的混沌机车骑兵可各自将其栓动手枪替换为1把阿斯塔特链锯剑。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 最多 2 名混沌机车骑兵可各自将他们的复合栓动枪替换为 1 件复合武器，或可配备以下其中之一：\n? 1 门火焰枪\n? 1 门熔火枪\n? 1 门电浆枪",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "混沌领主": [
      ...
      },
      {
        "id": "faction-dark-pacts",
        "name": "黑暗契约",
        "text": "若你的军队阵营为 **异端阿斯塔特(Heretic Astartes)**，则此单位每次被选定进行射击或格斗时，可进行一次「黑暗圣约」。若此单位进行黑暗圣约，则必先进行领导力测试；若测试失败，该单位将承受 D3 点道德伤害。之后，选择以下其中一项能力，使该单位的武器获得直到阶段结束为止：\n\n■ **[致命一击]**\n■ **[连击 1]**\n\n狂热的异端阿斯塔特勇士以疯狂的虔诚向混沌诸神祈祷，许诺最邪恶的祭祀以换取其力量。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "终结者护甲混沌领主": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 此模型的联合枪栓枪与崇高武器可替换为 1 成对的被诅咒武器。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    "跳跃背包混沌领主": [
      ...
      },
      {
        "id": "faction-dark-pacts",
        "name": "黑暗契约",
        "text": "若你的军队阵营为 **异端阿斯塔特(Heretic Astartes)**，则此单位每次被选中进行射击或近战时，可进行「暗黑契约」。若进行契约，该单位必须先进行领导力测试才能解决该契约的任何效果；若测试失败，该单位承受 D3 点灵能伤害。然后，为该单位的武器选择下列能力之一，直到阶段结束：\n\n■ **[致命一击]**\n■ **[连击 1]**\n\n异端阿斯塔特的亵渎勇士以狂热虔诚之心祈求混沌之神，为了获得恶魔力量而献出最邪恶的祭品。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此模型的爆弹手枪和受诅武器可被替换为1把双联闪电爪。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "混沌破坏者型掠食者战车": [
      ...
      },
      {
        "id": "faction-dark-pacts",
        "name": "黑暗契约",
        "text": "若你的军队阵营为 **异端阿斯塔特(Heretic Astartes)**，每当一个持有此能力的单位被选中进行射击或战斗时，它可以进行暗黑契约。若它这样做，必须先进行领导力检定，暗黑契约的效果才会生效；若该检定失败，该单位将承受 D3 点灵能伤害。随后，为该单位的武器选择下列其中一项能力，直到阶段结束为止：\n\n■ **[致命一击]**\n■ **[连击 1]**\n\n异端阿斯塔特的亵渎勇士们以狂热的虔诚祈请混沌之神，为了获得邪恶的恩赐而承诺献上最卑鄙的祭品。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "混沌犀牛战车": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战斗装备能力",
        "text": "■ 此模型可装备 1 个浩劫炮塔，或可将 1 挺联合鱼飣栓动枪替换为 1 个浩劫炮塔。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "混沌终结者小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器装备能力",
        "text": "■ 此单位每 5 个模型，1 个终结者的联合枪管可替换为以下其中之一：\n? 1 重型火焰枪\n? 1 割肉机关枪",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 任意数量的模型各自可将其复合枪机替换为 1 枚复合武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战力装备能力",
        "text": "■ 对于此单位中的每 5 个模型，1 个模型的组合爆弹枪和诅咒武器可以替换为 1 对诅咒武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 此单位中每 5 个模型，最多 3 个模型可各自将其诅咒武器替换为 1 动力拳。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战甲能力",
        "text": "■ 此单位中每 5 个模型中的 1 个模型的诅咒武器可被替换为 1 个链锯拳套。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "神选者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战斗装备能力",
        "text": "■ 此单位中每满 5 个模型，最多 2 个模型可各将其栓动手枪替换为 1 具电浆手枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此单位每 5 个模型，最多 2 个模型可各自将冲锋枪替换为 1 件复合武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "护甲能力",
        "text": "■ 此单位每5个模型，1个模型的步枪与诅咒武器可替换为1对诅咒武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器装备能力",
        "text": "■ 此单位每5个模型，1个配备栓动枪的模型可将其诅咒武器替换为1个力量拳。该模型的栓动枪不能被替换。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "污染者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 此模型的重型业火喷射器可替换为以下其中一项：\n? 1门黑帝斯雷射加农炮\n? 1门重型收割者自动炮\n? 1根电弧鞭（一个模型最多只能配备一根电弧鞭）",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此模型的重型飞弹发射器可替换为以下其中之一：\n? 1 门黑帝斯重射枪\n? 1 门重型收割者自动炮\n? 1 门电蚀枪（一个模型最多不能配备超过一门电蚀枪）",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "恶角野兽人": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 1 个堕落兽人的近战武器可被替换为 1 根堕落法杖。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    "铸造恶魔": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器装备能力",
        "text": "■ 此模型的 2 个黑帝斯自动炮可替换为 2 个外质毁灭炮。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此模型的地狱犬颚部可替换为 1 门等离子炮和 1 具装甲肢体。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "浩劫": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 任意数量的地狱之祸可各自将其地狱之祸自动炮或地狱之祸战斗炮替换为下列其中一项：\n? 1 件地狱之祸自动炮\n? 1 件地狱之祸重型冲锋枪\n? 1 件地狱之祸战斗炮\n? 1 件地狱之祸飞弹发射器\n? 1 件地狱之祸屠杀链炮",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    "地狱兽": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此模型装备的每一个地狱残暴拳，可替换为以下其中一项：\n? 1挺组合爆弹枪\n? 1具重型火焰喷射器",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "军团战士": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备能力",
        "text": "■ 任意数量的军团战士可各自将其栓动式枪机枪替换为 1 把阿斯塔特链锯刀。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 此单位每满5个模型，1个Legionary的bolgun可替换为以下之一（不允许重复）：\n? 1支plasma手枪和1把Astartes链剑\n? 1支火焰枪\n? 1挺havoc自动炮\n? 1挺重型bolgun\n? 1支Las枪\n? 1支熔火枪\n? 1套飞弹发射器\n? 1支plasma枪\n? 1门reaper链炮",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "骑地狱追猎者的不谐领主": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 此模型的地狱追猎者自动枪炮可被替换为 1 具毁灭火焰枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备能力",
        "text": "■ 此模型的科技病毒注射器可被替换为 1 件岩浆切割器。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "复仇之爪": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 任意数量的军团战士可各自用 1 把阿斯塔特链剑替换其爆弹枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 若此单位包含 10 个模型，一个军团兵的栓动步枪可替换为下列其中之一：\n? 1 挺重栓动步枪\n? 1 枚飞弹发射器",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 最多四名 军团战士 可各自将其枪管枪替换为以下其中一项（不允许重复）：\n? 1 把诅咒武器\n? 1 把 Nostraman 链镰刀\n? 1 对诅咒武器\n? 1 把食音刃和 1 把 Astartes 链锯剑",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "猛禽": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装配置能力",
        "text": "■ Raptor Champion的爆弹手枪可被替换为1把电浆手枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备能力",
        "text": "■ 此单位每5个模型，最多2个破裂者可各自将其栓枪手枪替换为1枝电浆手枪（这些模型的阿斯塔特链锯剑不能被替换）。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装能力",
        "text": "■ 此单位每 5 个模型，最多 2 个掠夺者可各自将其阿斯塔特链锯剑替换为 1 把重型近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战术装备能力",
        "text": "■ 每 5 个此单位的模型，1 个掠夺者可将其阿斯塔特链刀替换为 1 个突变体。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装能力",
        "text": "■ 最多 2 个快速袭击者可各自将其阿斯塔特链锯剑替换为以下选项之一（你不能选择同一选项超过一次）：\n1 支火焰枪及 1 件近战武器\n1 支熔火枪及 1 件近战武器\n1 支电浆枪及 1 件近战武器",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 若此单位包含 10 个模型，最多 2 个额外袭击者可各自将其阿斯塔特链剑替换为下列其中之一选项（你不能选择相同选项超过一次）：\n1 个火焰枪与 1 个格斗武器\n1 个熔枪与 1 个格斗武器\n1 个电浆枪与 1 个格斗武器",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    "红海盗劫掠者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装配置能力",
        "text": "■ 红色海盗突击者冠军的栓动手枪可替换为 1 把手焰枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 此单位每满 5 个模型：\n? 1 名红海盗突击者的栓动枪可替换为 1 门熔火枪\n? 1 名红海盗突击者的掠夺者刀片可替换为 1 把动力拳套",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "叛变卫军小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 最多 3 名异端卫兵可各自将其雷射枪替换为下列之一（不允许重复）：\n? 1 异端迫击炮发射器\n? 1 火焰枪\n? 1 熔火枪\n? 1 电浆枪\n? 1 异端狙击枪",
        "status": "仅供查阅",
        "effects": []
      },
      {
