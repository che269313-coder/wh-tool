...
(function (root) {
  ...
  "unitRules": {
    "畸变体": [
      ...
      {
        "id": "faction-cult-ambush",
        "name": "教派伏击",
        "text": "若你的军队阵营为 **基因窃取者教派(Genestealer Cults)**，你在战斗开始时根据战斗规模获得回光返照点数，如下所示。\n\n■ **攻略战**：6 回光返照点数\n■ **打击战**：10 回光返照点数\n■ **全面战争**：14 回光返照点数\n\n每当你的军队中有一个单位被摧毁时，若该单位中的每个模型都具有此能力，你可花费依该单位起始兵力而定的回光返照点数（确切数量依官方表格）。\n\n若你这样做：\n\n■ 添加一个与你被摧毁单位相同的新单位到你的军队，处于教派埋伏中，在其起始兵力，所有伤口均保持满血，且该单位模型装备的任何 **[单发]** 武器视为尚未射击。\n■ 在战场上任何距所有敌方单位超过 9 英寸（水平距离）的地点放置一个教派埋伏标记（见下文）。如无法进行此操作，则不放置任何标记。\n\n教派埋伏中的单位\n\n教派埋伏是一种战略预备队。教派埋伏中的单位无法被迅速进攻战略针对，但可使用教派埋伏标记如下所述在战场上布阵，或在随后的回合中遵循战略预备队规则。\n\n教派埋伏标记\n\n使用 32 毫米圆形直径的标记作为教派埋伏标记。若任何敌方模型（不包括 **飞行器(Aircraft)**）在其移动后距你放置的教派埋伏标记在 9 英寸以内，该教派埋伏标记从战场上移除。在你对手下一个移动阶段的增援步骤结束时，对于战场上仍存在的每个你的教派埋伏标记，你可选择你军队中处于教派埋伏状态的一个单位并使用该教派埋伏标记布阵。为此，在战场上布阵该单位，使其距所有敌方单位超过 9 英寸（水平距离），该单位至少一个模型与该教派埋伏标记接触，所有其他模型完全位于该教派埋伏标记 3 英寸范围内（随后该教派埋伏标记从战场上移除）。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "阿基里斯山地车": [
      ...
      },
      {
        ...
        "name": "装备选项",
        "text": "■ 任意数量的模型可各自将其重型采矿雷射替换为以下其一：\n? 1门阿基里斯飞弹发射器\n? 1门重型迫击炮",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 任意数量的模型可各自将其照明弹发射器替换为以下其中之一：\n? 1 观测员\n? 1 勘测增强器",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "装备自动手枪的混血信徒": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 每 5 个单位中的模型，最多 3 个侍僧混种人可分别将其自动手枪与邪教爪及刀替换为 1 把重型采矿工具。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 助祭领袖的教派之爪与利刃可被替换为1套领袖的生化武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "装备喷火手枪的混血信徒": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位每有 5 个模型，最多 2 个侍祭杂交人可各自将其手持火焰枪替换为 1 拆除装药。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 侍祭领袖的邪教爪与刀可被替换为 1 套领袖的生物武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "阿塔兰豺狼摩托手": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位中每有 4 个阿塔兰豺狼骑手，最多 2 个阿塔兰豺狼骑手的近战武器各可替换为 1 柄阿塔兰动力武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 每 4 个阿塔兰豺狼骑兵，可有 1 个阿塔兰豺狼骑兵的阿塔兰小型武器改为 1 个榴弹发射器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 任意数量的阿塔兰狼四轮车可各将其重型钉枪替换为以下之一：\n? 1 个阿塔兰焚化枪\n? 1 个采矿雷射",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "混血变异兽": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 一个混种变异者的自动手枪可被替换为 1 个邪教圣像。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "混血新信徒": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 1 个配备混合火器的新兵混血体可配备 1 面邪教圣旗。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 每 10 个此单位内的模型，最多 2 个新兵混血人可各自将其混血步枪替换为以下其中之一：\n? 重型短枪\n? 采矿雷射\n? 地震炮\n\n 每 10 个此单位内的模型最多 1 个。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位每 10 个模型，最多 2 个新型杂交体可各将其杂交火枪替换为以下之一：\n? 火焰枪\n? 榴弹发射器\n? 蛛网枪\n\n 此单位每 10 个模型最多 1 种。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "圣裁者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此模型的 圣裁者 生物匕首可被替换为 1 支邪教狙击枪及 1 件近战武器。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
