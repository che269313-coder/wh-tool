  ...
  "unitRules": {
    ...
    "族群领主": [
      ...
      },
      {
        ...
        "name": "亚空间阴影",
        "text": "若你的军队阵营是 **泰伦虫族(Tyranids)**，一场战斗一次，在任一玩家的指挥阶段，若你的军队中有一个或多个具有此能力的单位在战场上，你可释放「亚空间阴影」。当你这样做时，战场上的每个敌军单位必须进行战斗震慑测试。每当敌军单位进行该测试时，若它在你军队中一个或多个 **突触(Synapse)** 单位的 6\" 内，从该测试减 1。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "刽子手": [
      ...
      },
      {
        ...
        "name": "装备选项",
        "text": "■ 任意数量模型的卡尼芬克斯额外的镰刀爪可替换为以下之一：\n? 1 具脑蛆分泌物的吞噬者\n? 1 具脑蛆分泌物的吞噬者\n? 1 重型毒液炮\n? 1 绞肉炮\n? 1 卡尼芬克斯碎骨爪",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "虫巢护卫": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 任意数量的模型各可将其冲击加农炮替换为 1 把穿刺加农炮。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    "虫巢暴君": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此模型的怪物撕裂爪可替换为下列其中之一：\n? 1 重型毒液炮\n? 1 绞杀棘炮\n\n 此模型不可同时配备绞杀棘炮和重型毒液炮。此模型最多配备 1 门重型毒液炮，且最多配备 1 门绞杀棘炮。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "枪虫": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位的所有模型可各自将其肉食啃咬虫替换为 1 支异形兽肉食啃咬虫。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位内的所有模型各可将其肉蛀虫替换为 1 把小蛋虫脊棘枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位每有10个模型，1个模型的射击武器可被替换为1个分晶发射器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位中每10个模型，1个模型的远程武器可被替换为1把刺虫步枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位每 10 个模型，可将 1 个模型的远程武器替换为 1 个绞缚网。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "装备远程活体武器的泰伦武士": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位中每 3 个模型，1 个模型的吞噬者可被替换为 1 具带刺绞杀者。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 此单位中每 3 个模型，1 个模型的吞噬者可替换为 1 个毒液炮。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "暴君护卫": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备选项",
        "text": "■ 任意数量的模型各可将其撕裂爪和撕裂爪替换为下列之一：\n? 1 把骨劈刀、鞭式利刃和撕裂爪\n? 1 对粉碎爪和撕裂爪",
        "status": "仅供查阅",
        "effects": []
      }
    ],
