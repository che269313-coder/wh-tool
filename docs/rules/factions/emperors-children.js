...
(function (root) {
  ...
  "unitRules": {
    "混沌兰德掠袭者战车": [
      ...
      {
        "id": "faction-thrill-seekers",
        "name": "寻求刺激者",
        "text": "此单位在前进或后撤的回合中仍符合射击与宣告冲锋的资格，但这麽做时：\n\n■ 不能以回合开始时其位于交战范围内的单位为目标。\n■ 不能以本阶段中已成为其他单位冲锋或攻击目标的单位为目标。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "魅魔": [
      ...
      {
        "id": "faction-pact-of-excess",
        "name": "放纵契约",
        "text": "编组军队时，除非另有特别说明，否则你不能选择 **放纵军团（LEGIONS OF EXCESS）** 作为你的军队派系。",
        "status": "仅供查阅",
        "effects": []
      },
      {
