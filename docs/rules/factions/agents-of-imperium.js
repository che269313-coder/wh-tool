...
(function (root) {
  ...
  "unitRules": {
    "天鹰杀戮小队": [
      {
        "id": "faction-assigned-agents",
        "name": "指派探员",
        "text": "若你的军队阵营为 **帝国特勤(Agents of the Imperium)**，则在「选择分遣队规则」步骤中，可如常从本出版物选择其中一个可用的分遣队。\n\n若你的军队阵营不是 **帝国特勤(Agents of the Imperium)**，但你的军队中每个模型都具有 **帝国(Imperium)** 关键字，你可以在军队中纳入 **帝国特勤(Agents of the Imperium)** 单位，即使它们没有在「选择军队阵营」步骤中选择的阵营关键字。在此情况下，你可在军队中纳入的 **帝国特勤(Agents of the Imperium)** 单位的最大数量取决于战斗规模，如下所示。\n\n-\n\n注意，你可如常在此类军队中纳入 **帝国特勤(Agents of the Imperium)运输工具(Transport)单位**，但每个单位必须在战役开始时内部有一个或多个单位，否则该单位无法为该战役部署，且将被视为在第一战斗回合期间被摧毁。\n\n遍布帝国各地，存在着许多武装组织和神秘机构。来自这些团体的武装战士或孤行特务拥有专业技能、特殊装备和既得利益，使他们被派往更大型帝国军队。有些是由军队指挥官为了其特定能力而征用，而其他则由其神秘主人分配以达成特殊议程。最强大的拥有在战场上强行出现的权威和名声。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        ...
        "name": "战装能力",
        "text": "■ 每5个单位模型，最多一个模型的业火重爆弹枪可替换为以下其中之一：\n? 1个破片加农炮。\n? 1支地狱风暴爆弹步枪和1个阿斯塔特掷弹筒。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战甲能力",
        "text": "■ 该单位每有 5 个模型，其中最多一个模型的重雷霆战鎚可以替换为 1 个动力武器和 1 个阿斯塔特盾。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战斗装备能力",
        "text": "■ 每 5 个单位内的模型，最多 1 个模型的斥候机枪可被替换为 1 挺血浆焚化枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装能力",
        "text": "■ 每 5 个模型中，最多 1 个模型的死亡守望神枪手爆弹卡宾枪可被替换为 1 把战斗匕首。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "卡里杜斯刺客": [
      ...
      },
      {
        "id": "faction-assigned-agents",
        "name": "指派探员",
        "text": "若你的军队阵营为 **帝国特勤(Agents of the Imperium)**，则在「选择分遣队规则」步骤中，你可如常选择本出版物中的可用分遣队之一。\n\n若你的军队阵营并非 **帝国特勤(Agents of the Imperium)**，但军队中每个模型都具有 **帝国(Imperium)** 关键字，你可在军队中纳入 **帝国特勤(Agents of the Imperium)** 单位，即使它们不具有你在「选择军队阵营」步骤中所选的阵营关键字。此时，你可在军队中纳入的 **帝国特勤(Agents of the Imperium)** 单位的最大数量取决于战斗规模，如下所示。\n\n-\n\n请注意，你可如常在此类军队中纳入 **帝国特勤(Agents of the Imperium)专用运输工具(Dedicated Transport)** 单位，但每个单位必须在战斗开始时内部搭乘一个或多个单位，否则无法为该战斗部署，并将在首个战斗回合期间视为已被摧毁。\n\n整个帝国之中，存在着许多武装组织和神秘机构。来自这些团体的武装战士或独行特务具有专门技能、特殊装备和既得利益，促使他们被派遣支援更大的帝国军队。有些是由军队指挥官因其特定能力而征召，而另一些则是由其隐秘主人指派以达成特定目标。最强大的机构具有足够的权力与声誉在战场上强制执行其存在。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "黑星渡鸦": [
      ...
      },
      {
        "id": "faction-assigned-agents",
        "name": "指派探员",
        "text": "若你的军队阵营为 **帝国特勤(Agents of the Imperium)**，则在「选择分遣队规则」步骤中，你可以如常从本出版物中选择一个可用的分遣队。\n\n若你的军队阵营不是 **帝国特勤(Agents of the Imperium)**，但你军队中的每个模型都有 **帝国(Imperium)** 关键字，你可在军队中纳入 **帝国特勤(Agents of the Imperium)** 单位，即使它们没有你在「选择军队阵营」步骤中选择的阵营关键字。在此情况下，你可以纳入的 **帝国特勤(Agents of the Imperium)** 单位的最大数量取决于战役规模，如下所示。\n\n-\n\n请注意，你可如常在此类军队中纳入 **帝国特勤(Agents of the Imperium)专用运输工具(Dedicated Transport)** 单位，但每个单位必须在战斗开始时内部搭载一个或多个单位，否则无法为该战役部署，且在第一战斗回合期间将视为已被摧毁。\n\n在帝国各地，存在着数不胜数的军事组织和神秘机构。这些团体的武装战士或独行特务具备专业技能、非常规装备与既得利益，使他们得以奉派支援更庞大的帝国军队。有些是由军队指挥官因其特殊能力而征召，其他则由其隐秘主人指派以达成特定目标。最强大的机构拥有权力与声望来在战场上强行施加其影响。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此模型的双联突击加农炮可替换为 1 个双联雷射加农炮。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备能力",
        "text": "■ 此模型的 2 支黑星火箭发射器可被替换为 2 支风暴打击飞弹发射器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "丘里克斯刺客": [
      ...
      },
      {
        "id": "faction-assigned-agents",
        "name": "指派探员",
        "text": "若你的军队阵营为 **帝国特勤(Agents of the Imperium)**，则在「选择分遣队规则」步骤中，可如常选择本出版物中的可用分遣队之一。\n\n若你的军队阵营不是 **帝国特勤(Agents of the Imperium)**，但你军队中的每个模型都具有 **帝国(Imperium)** 关键字，你可在军队中纳入 **帝国特勤(Agents of the Imperium)** 单位，即使它们不具有你在「选择军队阵营」步骤中所选的派系关键字。在此情况下，你可纳入的 **帝国特勤(Agents of the Imperium)** 单位的最大数量取决于战斗规模，如下所示。\n\n-\n\n注意你可如常在此类军队中纳入 **帝国特勤(Agents of the Imperium) 专用运输工具(Dedicated Transport)** 单位，但每个单位必须在战斗开始时内部搭乘一个或多个单位，否则无法为该战斗部署，且将被视为在第一战斗回合期间被摧毁。\n\n在整个帝国中，存在许多武装组织和隐蔽机构。这些团体的武装战士或独立特工具有专门技能、不寻常的装备和既得利益，使他们被编配至更大的帝国军队中。有些由军队指挥官为了其特殊能力而征调，而另一些则由其隐藏的主人指派以实现特定议程。最强大的则具有在战场上强制部署的权限和声望。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "死亡守望杀戮小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战斗装备能力",
        "text": "■ 此单位中每5个模型，最多2个模型可以各将其爆弹枪和动力武器替换为以下之一：\n? 1把爆弹枪和1面阿斯塔特盾\n? 1件动力武器和1面阿斯塔特盾",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装装备能力",
        "text": "■ 此单位中每5个模型，最多2个模型可将各自的爆弹枪和动力武器替换为1把死亡守望雷霆战鎚。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 每 5 名此单位中的模型，可让 1 个模型将其爆弹枪及动力武器替换为 1 门猎手步枪和 1 件近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 此单位每5个模型，最多2个模型可各将其枪管枪和近战武器替换为1把死亡守望猎枪和1件近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备装备能力",
        "text": "■ 此单位每 5 个模型中，1 个模型可将其栓动步枪和力量武器替换为 1 门迸裂炮和 1 把近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 此单位每满 5 个模型，1 个模型可将其栓动枪和近战武器替换为 1 挺因费诺斯重型栓动枪和 1 件近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器配备能力",
        "text": "■ 监视军士长的 爆弹枪 可以被替换为 1 把 combi-武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "强征小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装能力",
        "text": "■ 最多2个 Exaction 警卫可各自将其 Arbites 战斗霰弹枪替换为以下其中之一（不可重复）：\n? 1 把刑执霰弹枪\n? 1 把 Arbites 榴弹发射器\n? 1 挺重型射击枪\n? 1 把蛛网枪",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 1 名配备仲裁者战斗霰弹枪的「判决警卫」可配备 1 把「刑罚锤」。*",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 1名其他配备仲裁官战斗猎枪的处罚警惕者可配备1套仲裁官医疗包。*",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 1 个配备仲裁官战斗霰弹枪的其他执行者警惕者可配备 1 部灵魂罪孽扫描仪。*",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "灰骑士终结者小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 1 名配备风暴枪栓枪的灰骑士终结者可配备 1 面古人之旗。*",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 1 名灰骑士终结者可将其风暴冲锋枪替换为 1 支奈瑟西姆。*",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "帝国海军跳帮者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 1 名导航军士的导航霰弹枪可被替换为 1 把自动手枪和 1 把能量武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器配备能力",
        "text": "■ 1 位 Navis 武装兵的 Navis 鸣枪可以被替换为 1 把 自动手枪 和 1 把 链锯拳套。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "审判官": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 此模型的祝圣守卫可替换为 1 项灵能天赋及 1 道「灵能冲击波」。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战斗装备能力",
        "text": "■ 若此模型配备 1 件灵能天赋，其宗教法庭近战武器可替换为 1 力场武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "审判庭特勤": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此单位每有 5 个审判庭密探，就可配备 1 个古墓头颅。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备装备能力",
        "text": "■ 此单位每 5 个审判庭干员中，1 个审判庭干员可配备 1 把电浆手枪。**",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 此单位每 5 名审判庭干员中，1 名审判庭干员可配备 1 把断裂刀。**",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武装能力",
        "text": "■ 此单位每5名宗教法庭特务，1名宗教法庭特务可配备1根秘术法杖。**",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战争装备能力",
        "text": "■ 任意数量的枪械侍僧各可将其重型栓动枪替换为下列之一：\n? 1 个多重熔火炮\n? 1 个电浆炮",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "国教牧师": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "装备能力",
        "text": "■ 此模型的狂信者文迪克多可被替换为 1 件圣水手枪和 1 件力量武器。",
        "status": "仅供查阅",
        "effects": []
      }
    ],
    ...
    "净化者": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 1 名传教士模型可将其 1 支电浆枪替换为 1 支熔火枪。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 1个配备1把电浆枪的传教士模型可配备1枚圣火（此模型的电浆枪不能被替换）。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "武器装备能力",
        "text": "■ 1 个圣化者模型可将其 1 个圣化者近战武器替换为 1 把圣堂手焰枪和 1 个近战武器。",
        "status": "仅供查阅",
        "effects": []
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战具能力",
        "text": "■ 1 个圣化者模型可将其 1 把圣化者近战武器替换为 1 把近战武器与 1 座帝国圣像。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "战斗修女小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战装能力",
        "text": "■ 1名配备1把爆弹枪的战斗修女可配备1座帝国圣像（该模型的爆弹枪无法被替换）。",
        "status": "仅供查阅",
        "effects": []
      },
      {
    ...
    "警戒者小队": [
      ...
      },
      {
        "id": "wargear-wargear-ability",
        "name": "战备能力",
        "text": "■ 最多2名防卫者可各自将其执法官战斗猎枪替换为以下其中之一（不可重复）：\n? 1把行刑官猎枪\n? 1具执法官榴弹发射器\n? 1具重型机枪\n? 1具网枪",
        "status": "仅供查阅",
        "effects": []
      },
      {
