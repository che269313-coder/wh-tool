  ...
  "unitRules": {
    ...
    "毁灭之锤": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6+2, Firing Deck 6",
          "kind": "core"
        }
      },
      {
    ...
    "末日之锤": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6+2, Firing Deck 12",
          "kind": "core"
        }
      },
      {
    ...
    "刚特幽灵": [
      {
        ...
        "source": {
          "englishName": "Fights First, Infiltrators, Lone Operative, Stealth",
          "kind": "core"
        }
      },
      {
    ...
    "领主元帅德雷尔": [
      {
        ...
        "source": {
          "englishName": "Leader, Feel No Pain 6+",
          "kind": "core"
        }
      },
      {
    ...
    "暴风兵指挥组": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Leader, Deep Strike",
          "kind": "core"
        }
      },
      {
    ...
    "暴风兵飞鹰小队": [
      ...
      },
      {
        ...
        "name": "伺服哨卫",
        "text": "当此单位使用「深入打击」能力在战场上部署时，天鹰守卫官可用其哨兵武器（其哨兵火焰枪、哨兵榴弹发射器或哨戒热射阵列枪）进行射击。\n\n**设计师的备注：** *在此单位旁放置一个伺服机器哨兵标记以提醒你。*",
        "status": "已结构化，当前仅供查阅",
        "effects": [],
        "source": {
    ...
    "女武神炮艇": [
      {
        ...
        "effects": [],
        "source": {
          "englishName": "Deadly Demise D6, Hover",
          "kind": "core"
        }
      },
      {
